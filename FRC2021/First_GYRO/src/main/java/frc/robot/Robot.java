...
public class Robot extends TimedRobot {
  ...
  private final L_Motor lm = new L_Motor();
  private final R_motor rm = new R_motor();
  ...
  public void autonomousPeriodic() {
    double error = (Constants.POINT - gyro.getAngle())/360;
    ...
    lm.Drive(-outputspeed-0.1);
    rm.Drive(outputspeed-0.1);
    lastTimestamp = Timer.getFPGATimestamp();
    lasaterror = error;
  }
