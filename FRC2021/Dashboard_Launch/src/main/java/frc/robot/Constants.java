...
public final class Constants {
    ...
    //Defaul tvalue
    public final static double DEF_TOP_MOTOR_VALUE = 0;
    public final static double DEF_BOTTOM_MOTOR_VALUE = 0;
    public final static double DEF_FEEDER_VALUE =0;
    public final static double DEF_PUSH_MOTOR_VALUE = 0;
    public final static double DEF_WAIT_TIME_VALUE=0;
}
